...
% Aggregating methods written by USC Radiomics, feature calculation derived
% from pyradiomics database. Citation (information used in GLDMStats function): 
% Van Griethuysen, J. J. M., Fedorov, A., Parmar, C., Hosny, A., Aucoin, N., 
% Narayan, V., Beets-Tan, R. G. H., Fillon-Robin, J. C., Pieper, S., Aerts, H. J. W. L. 
% (2017). Computational Radiomics System to Decode the Radiographic Phenotype. Cancer Research, 77(21), 
% e104–e107. `https://doi.org/10.1158/0008-5472.CAN-17-0339 <https://doi.org/10.1158/0008-5472.CAN-17-0339>`_

% Note: this was not included in the IBSI database, but offers an
% additional set of image features. 
