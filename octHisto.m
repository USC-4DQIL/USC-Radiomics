function fresult = octHisto(imgData, numLevels, binWidth)
...
fresult.mean1 = mean(imgDatanew);

%       Discretized intensity varaince
fresult.var = var(imgDatanew);  %MATLAB
